...
import no.fintlabs.metamodel.metadata.config.MetamodelProperties
...
class MetadataCache(
    ...
    private fun formatComponentName(domainName: String, packageName: String) =
        "$domainName${metamodelProperties.format}$packageName"
